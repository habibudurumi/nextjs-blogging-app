...
const Footer = () => {
  return (
    <footer className=' bg-dark rounded-lg text-light mb-10 p-10'>
      <div className='w-full grid grid-cols-4 gap-16 items-center'>
      ...
      <div className='self-start'>
        ...
        <span className='inline-block mt-2 text-light/50'>
      ...
      <p className='text-center text-light/30 mt-5'>&copy; 2024 All Rights Reserved</p>
    </footer>
  )
}
